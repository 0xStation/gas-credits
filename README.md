...
1. Permissionless ERC-4337 paymaster contract, [GasCredits.sol](./src/GasCredits.sol)
...
for protocols, dApps, and users to mint, distribute, and spend Gas Credits in Q1 2024.

### Spend Gas Credits – User self-sponsors from wallet balance
...
### Spend Gas Credits – User sponsored by a third party (eg dApp)
